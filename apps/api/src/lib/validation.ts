...
export const adminResourceSchema = z.object({
  ...
  bus_number: z.string().min(1).optional(),
  ...
  latitude: z.union([z.number(), z.string().min(1)]).optional(),
  longitude: z.union([z.number(), z.string().min(1)]).optional(),
  ...
  is_active: z.union([z.boolean(), z.string().min(1)]).optional(),
  role: z.string().min(1).optional(),
  status: z.string().min(1).optional(),
  transport_status: z.string().min(1).optional(),
  ...
  pickup_stop_id: z.string().min(1).optional(),
  drop_stop_id: z.string().min(1).optional(),
  assigned_bus_id: z.string().min(1).optional(),
  driver_id: z.string().min(1).optional(),
  user_id: z.string().min(1).optional(),
  email: z.string().email().optional(),
  phone_number: z.string().min(1).optional(),
  gps_device_id: z.string().min(1).optional(),
  sequence_order: z.union([z.number(), z.string().min(1)]).optional(),
