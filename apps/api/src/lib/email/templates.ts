    ...
    <body style="margin:0;padding:0;background:#f7f1e8;font-family:Segoe UI,Arial,sans-serif;color:#17324d;">
      <div style="max-width:640px;margin:0 auto;padding:32px 18px;">
        <div style="background:linear-gradient(180deg,#17324d 0%,#244968 100%);border-radius:28px 28px 0 0;padding:28px 32px;">
          <div style="font-size:13px;letter-spacing:1.8px;text-transform:uppercase;color:#f2bc74;font-weight:700;">SchoolBus Bridge</div>
...
export function buildWelcomeEmailHtml(input: { fullName: string }) {
  return baseLayout({
    ...
    body: `
      <p style="margin:0 0 16px;">Your SchoolBus Bridge account is ready.</p>
    ...
    `,
    footer: "This mailbox is used for transactional updates from SchoolBus Bridge."
  });
}
...
export function buildVerificationEmailHtml(input: {
  ...
  return baseLayout({
    ...
    body: `
      ...
      <p style="margin:0 0 16px;">Please verify your email address to activate your SchoolBus Bridge account and finish setup.</p>
...
export function buildForgotPasswordEmailHtml(input: {
  ...
  return baseLayout({
    ...
    body: `
      <p style="margin:0 0 16px;">Hi ${escapeHtml(input.fullName)},</p>
      <p style="margin:0 0 16px;">We received a request to reset your SchoolBus Bridge password.</p>
...
export function buildForgotPasswordOtpEmailHtml(input: {
  ...
  return baseLayout({
    ...
    body: `
      <p style="margin:0 0 16px;">Hi ${escapeHtml(input.fullName)},</p>
      <p style="margin:0 0 16px;">Use this one-time code to reset your SchoolBus Bridge password:</p>
...
export function buildAdminBroadcastEmailHtml(input: {
  ...
  return baseLayout({
    ...
    body: `
      ...
      <p style="margin:0;">Sent via SchoolBus Bridge administration.</p>
    `,
