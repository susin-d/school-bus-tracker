...
export type TripStatus = "scheduled" | "ready" | "active" | "paused" | "completed" | "cancelled" | "emergency";
export type AttendanceEventType = "boarded" | "dropped" | "absent" | "manual_override";
export type AlertType = "sos" | "delay" | "geofence" | "route_deviation" | "speed_anomaly" | "attendance_anomaly";
export type AlertSeverity = "low" | "medium" | "high" | "critical";
export type AlertStatus = "open" | "acknowledged" | "resolved";
export type LeaveRequestStatus = "pending" | "approved" | "rejected";
export type GeocodeStatus = "pending" | "resolved" | "failed";
export type TripStopStatus = "scheduled" | "arrived" | "boarded" | "dropped" | "no_show" | "skipped";
...
export interface RealtimeEventEnvelope {
    id: string;
    type: "trip.location.updated" | "trip.eta.updated" | "trip.stop.status_changed" | "trip.reoptimized";
    schoolId: string;
    tripId?: string;
    occurredAt: string;
