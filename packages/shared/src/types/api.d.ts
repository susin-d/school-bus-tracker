import type { AlertRecord, AlertType, AttendanceRecord, AttendanceEventType, GeocodeStatus, LiveDriverMapItem, NightlyPlannerRun, LeaveRequestRecord, ParentLiveTrip, RealtimeEventEnvelope, Role, SchoolMapSettings, StudentSummary, TripStopManifestItem, TripLocation, TripStatus, TripSummary, UserProfile } from "./domain.js";
